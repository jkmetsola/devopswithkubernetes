...
pip-compile -U --no-strip-extras "${WORKSPACE_FOLDER}"/imagefiles/requirements-dbhandler.in > /dev/null 2>&1
pip-compile -U --no-strip-extras "${WORKSPACE_FOLDER}"/imagefiles/requirements-logserver.in > /dev/null 2>&1
